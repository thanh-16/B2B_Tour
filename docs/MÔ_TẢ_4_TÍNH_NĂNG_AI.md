...
## 🤖 1. AI B2B COMBO CO-PILOT & DYNAMIC ITINERARY BUILDER (HOT ★★★★★)
...
## 📈 2. AI DYNAMIC PRICING & DEMAND FORECASTING CHO SUPPLIER (YIELD MANAGEMENT) (HOT ★★★★☆)
...
## 📊 3. NATURAL LANGUAGE BI ANALYTICS — CHAT VỚI DỮ LIỆU DOANH THU (TEXT-TO-SQL) (HOT ★★★★★)
...
### ⚙️ Cách Vận Hành Kỹ Thuật & Bảo Mật AST
...
## 🎨 4. MULTI-CHANNEL AI MARKETING CONTENT AUTO-PILOT (HOT ★★★★☆)
...
## 🗄️ MÃ DATABASE SQL MIGRATION (V025)

Cấu trúc cơ sở dữ liệu lưu trữ cho 4 tính năng AI trên đã được đóng gói tại file `db/migrations/V025__create_ai_features.sql`:
...
-- 3. AI Itinerary Drafts (Feature 1)
...
-- 4. AI Dynamic Pricing & Demand Forecasts (Feature 2)
CREATE TABLE ai_demand_forecasts (
    ...
    predicted_demand_increase_pct NUMERIC(5,2) NOT NULL,
    recommended_price_change_pct NUMERIC(5,2) NOT NULL,
